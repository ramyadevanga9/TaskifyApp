...
export default function TaskDescriptionInput(props: {
  ...
  return (
    <textarea
      ...
      className={`modal_input transition   duration-700  ease-in-out  border ${isWrong ? "border-red-500" : "border-transparent"}  resize-none  ${theme === "dark" ? "bg-stone-700 text-stone-300 placeholder:text-stone-300" : "bg-gray-100 text-gray-500 placeholder:text-gray-500"} p-1 w-modalInputs  ml-auto mr-auto  outline-none rounded-lg focus:border placeholder:text-sm placeholder:font-medium pl-2 pr-2 pt-3 pb-3 mobile1:w-11/12`}
    ></textarea>
  );
}
