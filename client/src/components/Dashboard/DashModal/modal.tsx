...
export default function Modal(props: {
  ...
  return (
    <form
      className={`modal  h-custom-height-modal   border border-primary2 p-1  w-modal rounded-3xl mobile1:h-full mobile1:rounded-none mobile1:border-0 mobile1:w-full`}
    >
      ...
      <section className="flex flex-col w-full pt-16 items-center p-6 gap-4 ">
        <TaskNameInput
          value={taskName}
        ...
        <div className="w-full flex flex-col items-center gap-5">
          ...
          <div className="w-full flex flex-col gap-2 mobile1:items-center">
            <TaskDateInput
              value={dateEnd}
